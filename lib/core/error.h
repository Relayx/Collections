...
const char* ERROR_INFO[] = {
  "OK",                                     /* 0 */
  "Null pointer reference of object",       /* 1 */
  "Null pointer reference of data",         /* 2 */
  "Out of memory",                          /* 3 */
  "Object values was spoiled",              /* 4 */
  ...
  "Object has already constructed",         /* 11 */
  "Object has already deleted",             /* 12 */
  "Out of range"                            /* 13 */
};
